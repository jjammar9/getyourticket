...
<template>
  <div class="w-[260px] pr-8 border-r border-gray-200 dark:border-gray-700 shrink-0">
    <button
      ...
      :class="
        activeCategory === category
          ? 'text-[#0f2147] dark:text-white scale-105'
          : 'text-gray-400 hover:text-[#0f2147] dark:hover:text-white hover:scale-105'
      "
    >
      <span
