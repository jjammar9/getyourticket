  ...
  <div class="group bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
    <div class="p-10 pb-0">
      <div class="overflow-hidden rounded-lg relative">
        ...
        <img :src="limitedSlides[currentSlide].image" alt="Press" loading="lazy" @error="limitedSlides[currentSlide].image = '/placeholder.jpg'" class="w-full h-52 object-cover transition-transform duration-500 group-hover:scale-125" />
      </div>
    </div>
