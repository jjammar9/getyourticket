...
const categories = computed(() => navData.value?.places?.categories || {});
</script>

<template>
  <Container>
    <div class="pt-32 pb-12">
      <Breadcrumbs :pages="[{ label: 'Attractions' }]" />
      <h1 class="text-[32px] font-bold tracking-[-0.5px] text-[#0b2343] mb-2">
        Attractions
      </h1>
      <p class="text-[16px] text-gray-500 mb-10">Must-see landmarks and destinations</p>
